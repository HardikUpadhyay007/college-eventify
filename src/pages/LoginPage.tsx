          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                >
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path fillRule="evenodd" d="M10 0C4.477 0 0 4.477 0 10c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10 0-5.523-4.477-10-10-10zm-1.143 17.086L3 10.714l1.714-1.714 4.143 4.143 6.429-6.429 1.714 1.714L8.857 17.086z" clipRule="evenodd" />
                  </svg>
                </a>
              </div>
            </div>
